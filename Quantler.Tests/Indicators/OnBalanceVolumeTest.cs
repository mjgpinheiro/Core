...
namespace Quantler.Tests.Indicators
{
    public class OnBalanceVolumeTests
    {
        ...
        [Fact(Skip = "Fix Me")]
        [Trait("Quantler.Indicators", "OnBalanceVolume")]
        public void ComparesAgainstExternalData()
        {
            ...
            TestHelper.TestIndicator(onBalanceVolumeIndicator, "spy_with_obv.txt", "OBV",
                (ind, expected) => Assert.Equal(
                    expected.ToString("0.##E-00"),
                    (onBalanceVolumeIndicator.Current.Price).ToString("0.##E-00")
                    )
                );
        }
        ...
        public void ResetsProperly()
        {
            ...
            Assert.True(onBalanceVolumeIndicator.IsReady);
