...
{
    public class MidPriceTests : CommonIndicatorTests<DataPointBar>
    {
        #region Protected Properties

        protected override string TestColumnName => "MIDPRICE_5";

        protected override string TestFileName => "spy_midprice.txt";
