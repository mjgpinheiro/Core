...
{
    /// <summary>
    /// Test class for QuantConnect.Indicatorsentity
    /// </summary>
    public class IdentityTests
    {
        ...
        public void ResetsProperly()
        {
            ...
            Assert.False(identity.IsReady);
            Assert.Equal(0m, identity.Current.Price);
            ...
            Assert.Equal(2, identity.Samples);

            identity.Reset();

            Assert.False(identity.IsReady);
            Assert.Equal(0, identity.Samples);
        }
        ...
        public void TestIdentityInvariants()
        {
            ...
            identity.Update(new IndicatorDataPoint(DateTime.UtcNow, TimeZone.Utc, value));
            Assert.True(identity.IsReady);
            Assert.Equal(value, identity.Current.Price);
        }
