...
namespace Quantler.Indicators
{
    ...
    public class Stochastic : BarIndicator
    {
            ...
            : base(name)
        {
            ...
            FastStoch = new FunctionalIndicator<DataPointBar>(name + "_FastStoch",
                input => ComputeFastStoch(period, input),
                fastStoch => _maximum.IsReady,
                () => _maximum.Reset()
                );

            StochK = new FunctionalIndicator<DataPointBar>(name + "_StochK",
                input => ComputeStochK(period, kPeriod, input),
                stochK => _maximum.IsReady,
                () => _maximum.Reset()
                );

            StochD = new FunctionalIndicator<DataPointBar>(name + "_StochD",
        ...
        /// </summary>
        public IndicatorBase<DataPointBar> FastStoch { get; }
        ...
        /// </summary>
        public IndicatorBase<DataPointBar> StochD { get; }

        /// <summary>
        /// Gets the value of the Slow Stochastics given Period K.
        /// </summary>
        public IndicatorBase<DataPointBar> StochK { get; }
