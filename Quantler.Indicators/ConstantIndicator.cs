...
namespace Quantler.Indicators
{
        ...
        where T : DataPoint
    {
            ...
            : base(name)
        {
            ...
            Current = new IndicatorDataPoint(DateTime.MinValue, TimeZone.Utc, value);
        }
        ...
        public override void Reset()
        {
            ...
            Current = new IndicatorDataPoint(DateTime.MinValue, TimeZone.Utc, _value);
        }
        ...
        protected override decimal ComputeNextValue(T input) => _value;
