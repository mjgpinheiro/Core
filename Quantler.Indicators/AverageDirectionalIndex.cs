...
namespace Quantler.Indicators
{
    ...
    public class AverageDirectionalIndex : BarIndicator
    {
            ...
            : base(name)
        {
            ...
            TrueRange = new FunctionalIndicator<DataPointBar>(name + "_TrueRange",
                currentBar =>
                {
            ...
            DirectionalMovementPlus = new FunctionalIndicator<DataPointBar>(name + "_PositiveDirectionalMovement",
                currentBar =>
                {
            ...
            DirectionalMovementMinus = new FunctionalIndicator<DataPointBar>(name + "_NegativeDirectionalMovement",
                currentBar =>
                {
        ...
        private IndicatorBase<DataPointBar> DirectionalMovementMinus { get; }
        private IndicatorBase<DataPointBar> DirectionalMovementPlus { get; }
        private IndicatorBase<IndicatorDataPoint> SmoothedDirectionalMovementMinus { get; }
        private IndicatorBase<IndicatorDataPoint> SmoothedDirectionalMovementPlus { get; }
        private IndicatorBase<IndicatorDataPoint> SmoothedTrueRange { get; }
        private IndicatorBase<DataPointBar> TrueRange { get; }
        ...
        private decimal ComputeNegativeDirectionalIndex()
        {
            ...
            var negativeDirectionalIndex = (SmoothedDirectionalMovementMinus.Current.Price / SmoothedTrueRange.Current.Price) * 100;
        ...
        private decimal ComputePositiveDirectionalIndex()
        {
            ...
            var positiveDirectionalIndex = (SmoothedDirectionalMovementPlus.Current.Price / SmoothedTrueRange.Current.Price) * 100;
