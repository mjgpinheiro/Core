...
{
    /// <summary>
    /// HitBTC datafeed conversion model
    /// </summary>
    /// <seealso cref="BaseConversionModel" />
    [Export(typeof(DataConversion))]
    internal class HitBTCDataConversionModel : BaseConversionModel
    {
        ...
        /// The data feed
        /// </summary>
        private readonly HitBtcDataFeed _hitBtcDataFeed;
        ...
        /// </summary>
        public HitBTCDataConversionModel()
        {
            _hitBtcDataFeed = new HitBtcDataFeed();
            _hitBtcDataFeed.Initialize(new LiveTradingMessage());
            DataFeed = _hitBtcDataFeed;
        }
        ...
        public override IEnumerable<DataPoint> GetDataPoints(InputLine inputLine)
        {
            ...
            if (lines.Length > 0 && long.TryParse(lines[0], out long currentutc))
            {
                ...
                //convert
                return _hitBtcDataFeed.ParseData(data, occured);
            }
            else
            {
