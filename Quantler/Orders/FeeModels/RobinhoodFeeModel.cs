...
namespace Quantler.Orders.FeeModels
{
    ...
    public class RobinhoodFeeModel : FeeModel
    {
        ...
        {
            //Robinhood does not charge commission, however it does have to charge regulatory trading fees
        ...
        /// <summary>
        /// TODO: set interest on margin for RobinHood (margin trading is not supported yet during Beta)
        /// </summary>
