...
namespace Quantler.Orders
{
    ...
    /// Error detail code
    /// </summary>
    public enum OrderTicketResponseErrorCode
    {
        /// <summary>
        /// No error
        /// </summary>
        ...
        /// <summary>
        /// Some order types require open exchangeModel
        /// </summary>
        ExchangeNotOpen = -15,
        ...
        /// <summary>
        /// Need 11 minute buffer before exchangeModel close
        /// </summary>
        ...
        /// <summary>
        /// All orders are invalidated while a quant fund is backfilling market state
        /// </summary>
        QuantFundBackfilling = -24,
        ...
        /// <summary>
        /// The order's ticker references a non-tradable security
        /// </summary>
        NonTradableSecurity = -28,

        /// <summary>
        /// The order's ticket references a non-exercisable security
        /// </summary>
        NonExercisableSecurity = -29,

        /// <summary>
        /// The risk management module did not allow this order to take place
        /// </summary>
        RiskManagementNotAllowed = -30,

        /// <summary>
        /// Supporting modules are not allowed to create a new position
        /// </summary>
        SupportingModuleNoEntry = -31
    }
}