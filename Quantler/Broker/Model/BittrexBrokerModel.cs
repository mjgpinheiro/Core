...
{
    /// <summary>
    /// Bittrex broker/exchangeModel (https://bittrex.com)
    /// </summary>
    /// <seealso cref="Quantler.Broker.Model.GenericBrokerModel" />
    public class BittrexBrokerModel : GenericBrokerModel
    {
        #region Public Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="BittrexBrokerModel"/> class.
        /// </summary>
        ...
        public BittrexBrokerModel(
                    AccountType accounttype,
                    LatencyModel latencymodel,
                    SlippageModel slippagemodel)
            : base(accounttype, new BittrexFeeModel(), new ImmediateFillBehaviour(), latencymodel, new GenericMarginCallModel(),
        ...
        /// Type of broker
        /// </summary>
        public override BrokerType BrokerType { get; protected set; } = BrokerType.Bittrex;
