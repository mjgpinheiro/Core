...
{
    /// <summary>
    /// HitBtc broker/exchangeModel (https://hitbtc.com)
    /// </summary>
    /// <seealso cref="Quantler.Broker.Model.GenericBrokerModel" />
    public class HitBtcBrokerModel : GenericBrokerModel
    {
        #region Public Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="HitBtcBrokerModel"/> class.
        /// </summary>
        ...
        public HitBtcBrokerModel(
                    AccountType accounttype,
                    LatencyModel latencymodel,
                    SlippageModel slippagemodel)
            : base(accounttype, new HitBtcFeeModel(), new ImmediateFillBehaviour(), latencymodel, new GenericMarginCallModel(),
        ...
        /// Type of broker
        /// </summary>
        public override BrokerType BrokerType { get; protected set; } = BrokerType.HitBtc;
